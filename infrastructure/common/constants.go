...
// Constants used in whole application for authentication with facebook
...
var GG_JWTTokenURL = appConfig.ValueOf("GG_JWTTokenURL")
var GG_AUTH_URL = appConfig.ValueOf("GGAuthURL")
var GG_TOKEN_URL = appConfig.ValueOf("GGTokenURL")
